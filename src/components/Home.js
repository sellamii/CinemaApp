...
function Home(props) {
    ...
    return (
        <Container className={classes.container}>
                ...
                >
                    <CustomTab label="Populaires" value={categories.POPULAR}/>
                    <CustomTab label="Top notés" value={categories.TOP_RATED}/>
                    <CustomTab label="A venir" value={categories.UPCOMING}/>
                </CustomTabs>
